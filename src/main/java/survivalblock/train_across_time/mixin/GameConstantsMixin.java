...
public interface GameConstantsMixin {
    ...
    private static Object delayShopEntriesInit(Object o, Consumer<Object> consumer, Operation<Object> original) {
        TrainAcrossTimeMixinHelper.SHOP_ENTRIES_INITIALIZER.set(() -> consumer.accept(o));
